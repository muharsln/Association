...
public class DonationFormRepository(AssociationDbContext context) : EfRepositoryBase<DonationForm, Guid, AssociationDbContext>(context), IDonationFormRepository { }
