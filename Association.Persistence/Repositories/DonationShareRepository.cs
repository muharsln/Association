...
public class DonationShareRepository(AssociationDbContext context) : EfRepositoryBase<DonationShare, Guid, AssociationDbContext>(context), IDonationShareRepository { }
